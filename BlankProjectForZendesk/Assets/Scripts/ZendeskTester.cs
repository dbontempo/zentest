...
public class ZendeskTester: MonoBehaviour
{
	...
	public void OnButtonClick() {
		...
		ZendeskSDK.ZDKConfig.AuthenticateAnonymousIdentity("Dav Bon","davidbon@yahoo.com","");
...
//			ZendeskSDK.ZDKConfig.AuthenticateJwtUserIdentity ("MyTestID");
	...
	*/
	...
	void RunProviderTests() {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetSections("200211985", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetArticles("200550945", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetAttachments("203326295", ZDKHelpCenterProvider.AttachmentType.Block, (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetArticle("203326295", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetSection("200658665", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.GetCategory("200211985", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.UpvoteArticle("203326295", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.DownvoteArticle("203326295", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.DeleteVote("1", (result, error) => {
			if (error != null) {
		...
		ZendeskSDK.ZDKHelpCenterProvider.SubmitRecordArticleView("203326295", null, (result, error) => {
			if (error != null) {
		...
		if (www.error == null)
		{
			...
			ZendeskSDK.ZDKUploadProvider.UploadAttachment(stringifiedImageData, "TestAttachment.png", "image/png", (result, error) => {
				if (error != null) {
					...
					ZDKCreateRequest req = new ZDKCreateRequest("tester@zendesk.com",
						"Test Attachments2",
						"Test Description2",
						tags,
						attachments);
